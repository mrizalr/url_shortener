...
const FindByShort string = `SELECT id, url, short_url, click_count, created_at, user_id FROM urls WHERE short_url = ?`

// Find URL by URL ID
const FindByID string = `SELECT id, url, short_url, click_count, created_at, user_id FROM urls WHERE id = ?`

// Find All Url
const FindAll string = `SELECT id, url, short_url, click_count, created_at, user_id FROM urls`
